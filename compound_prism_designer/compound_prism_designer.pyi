...
class FiberBeam(BeamDistribution):
    ...
    center_y: float
    def __new__(cls, core_radius: float, numerical_aperture: float, center_y: float) -> FiberBeam: ...
    def __getnewargs__(self) -> tuple[Any, ...]: ...
...
class CompoundPrism:
    ...
    def __getnewargs__(self) -> tuple[Any, ...]: ...
    def exit_ray(self, y: float, wavelength: float) -> tuple[Vector2D, UnitVector2D]: ...
...
class Spectrometer:
    ...
    def transmission_probability(self, wavelengths: np.ndarray, *, max_m: int = ...) -> np.ndarray: ...
